...
export default function ProjectCard({ title, description, href, technologies, imageUrl, delay = 0 }: ProjectCardProps) {
  return (
    <Link href={href} passHref legacyBehavior>
      <motion.a
        className="bg-white/5 rounded-lg shadow-lg border border-white/10 overflow-hidden block" // overflow-hidden pour les coins arrondis de l'image
